...
class PostCell: UITableViewCell {
    ...
    func configure(with post: Post) {
        ...
        // Username
        usernameLabel.text = post.postUser ?? "Deleted User"
        print(post.postUser ?? "No username")
        //Location
        
        locationLabel.text = (post.locationCity ?? "Unknown City") + ", " + (post.locationCountry ?? "Unknown Country")
